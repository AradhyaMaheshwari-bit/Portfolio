  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(ellipse at 30% 0%, color-mix(in oklab, var(--color-accent) 18%, transparent), transparent 70%)',
        }}
      />

      <div className="relative flex h-full min-h-[200px] flex-col">
        {/* Faux terminal/window chrome — recognizable as a placeholder, not a fake screenshot */}
        <div className="flex items-center gap-1.5 border-b border-[color:var(--color-border)] px-3 py-2">
          <span aria-hidden="true" className="h-2 w-2 rounded-full bg-[color:var(--color-border-strong)]" />
          <span aria-hidden="true" className="h-2 w-2 rounded-full bg-[color:var(--color-border-strong)]" />
          <span aria-hidden="true" className="h-2 w-2 rounded-full bg-[color:var(--color-border-strong)]" />
        ...
        <div className="border-t border-[color:var(--color-border)] px-3 py-2 text-[10px] uppercase tracking-wider text-[color:var(--color-text-muted)]">
  ...
  return (
    <div className="space-y-3 font-mono text-[11px] leading-relaxed">
      <div className="flex items-start gap-2.5">
        <span aria-hidden="true" className="mt-0.5 h-6 w-6 shrink-0 rounded-full bg-[color:var(--color-surface-2)]" />
...
function DataChrome() {
  ...
  return (
    <div className="space-y-3 font-mono text-[10px]">
      ...
      <div className="space-y-1">
        {rows.map((h, i) => (
          <div key={i} className="flex items-center gap-2">
            ...
            <span
              className="h-2 rounded-sm bg-[color:var(--color-accent)]/70"
              style={{ width: `${h * 90}%` }}
              aria-hidden="true"
            />
      ...
      <div className="text-[color:var(--color-text-muted)]">output written: /clean/users_v3.json</div>
    </div>
  );
}
...
function AppChrome() {
  return (
    <div className="flex h-full flex-col gap-2 font-mono text-[10px]">
      <div className="rounded border border-[color:var(--color-border)] bg-[color:var(--color-bg)] px-3 py-2 text-right text-base text-[color:var(--color-text)]">
        42
      </div>
...
function WebChrome() {
  return (
    <div className="flex h-full flex-col gap-3 font-mono text-[10px]">
      ...
      <div className="space-y-2">
        <div className="h-2 w-3/4 rounded bg-[color:var(--color-surface-2)]" aria-hidden="true" />
        <div className="h-2 w-2/3 rounded bg-[color:var(--color-surface-2)]" aria-hidden="true" />
      </div>
      <div className="mt-auto grid grid-cols-2 gap-2">
        <div className="h-12 rounded border border-[color:var(--color-border)] bg-[color:var(--color-surface-2)]" aria-hidden="true" />
        <div className="h-12 rounded border border-[color:var(--color-border)] bg-[color:var(--color-surface-2)]" aria-hidden="true" />
      </div>
    </div>
  );
